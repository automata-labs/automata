...
/// @notice EmulationAlpha
contract EmulationAlpha is EmulatorStorage, UUPSUpgradeable, Initializable, Access {
    ...
    function _startAndEndBlock(uint256 pid) internal view returns (uint256 startBlock, uint256 endBlock) {
        (,,, startBlock, endBlock,,,,) = IGovernorAlpha(registry["governor"]).proposals(pid);
    }
